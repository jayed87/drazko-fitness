        ...
        <div className="container" id="trainers">
            ...
            <div className="row">
                <div className="col-lg-3">
                    <div class="card">
                        <img class="card-img-top" src={t1} alt="Card cap" />
                        <div class="card-body">
                ...
                <div className="col-lg-3">
                    <div class="card">
                        <img class="card-img-top" src={t2} alt="Card cap" />
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                ...
                <div className="col-lg-3">
                    <div class="card">
                        <img class="card-img-top" src={t3} alt="Card cap" />
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                ...
                <div className="col-lg-3">
                    <div class="card">
                        <img class="card-img-top" src={t4} alt="Card cap" />
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
